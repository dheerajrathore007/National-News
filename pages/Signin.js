...
export default class Signin extends Component{
  ...
  render(){
    return(
      ...
      <ScrollView>
        <View>
        <TouchableOpacity style={{width:'100%'}} ><Image style={{height:120,width:"90%",alignSelf:'center',marginTop:20}} resizeMode='contain' source={require('../Images/logo.jpeg')}/></TouchableOpacity>
          ...
          <TouchableOpacity onPress={()=>this.setState({visiblepass: !this.state.visiblepass})} ><Image style={{width:25,height:25,marginTop:10}} source={require('../Images/eye.png')}/></TouchableOpacity>
            ...
            <TouchableOpacity onPress={() => this.props.navigation.navigate("Verify")}><Text style={{alignSelf:'flex-end',marginRight:"7%",marginTop:20,fontWeight:'bold'}}>Forget Password?</Text></TouchableOpacity>
            ...
            style={{width:'50%',height:40,backgroundColor:'#2DB3FB',borderRadius:20,marginTop:50,alignSelf:"center",alignItems:'center',alignContent:'center'}}>
              ...
              <View style={{marginTop:20,flexDirection:"row",alignItems:'center',justifyContent:"space-between",marginTop:50}}>
            <View style={{width:'15%',borderWidth:0.5,height:0,marginLeft:'20%'}}/>
            <Text style={{fontWeight:"bold",color:"#000"}}>Or sign in with</Text>
            <View style={{width:'15%',borderWidth:0.5,height:0,marginRight:'20%'}} /></View>
...
<Text style={{fontWeight:'bold',marginBottom:20}}> Register</Text></TouchableOpacity>
    </View>
    </View> 
      </ScrollView>
      </SafeAreaView>
