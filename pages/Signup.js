  ...
  export default class Signup extends Component{
    ...
    render(){
      return(
        ...
        <ScrollView>
          <View>
          <TouchableOpacity style={{width:'100%'}} ><Image style={{height:120,width:"90%",alignSelf:'center'}} resizeMode='contain' source={require('../Images/logo.jpeg')}/></TouchableOpacity>
              ...
              <Text style={{width:'88%',alignSelf:'center',fontSize:20,marginTop:10}}>I am a</Text>
              ...
              <TouchableOpacity onPress={() => this.props.navigation.navigate("Detail")} style={{width:'40%',height:40,backgroundColor:'#2DB3FB',borderRadius:20,marginTop:25,alignSelf:"center",alignItems:'center',alignContent:'center'}}>
